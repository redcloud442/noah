const TermsOfServicePage = () => {
  return (
    <div className="text-justify text-sm text-muted-foreground space-y-4 flex flex-col justify-center w-full ">
      <h1 className="text-xl font-bold">SECTION 1 - ONLINE STORE TERMS</h1>
      <li>
    ...
    unauthorized purpose nor may you, in the use of the Service, violate any
      ...
      <h1 className="text-xl font-bold">SECTION 2 - GENERAL CONDITIONS</h1>
      <li>
      ...
      <li>
        ...
        noir-clothing.com/refund-policy
      </li>
      <li>
      ...
      <li>
        ...
        noir-clothing.com/policies/refund-policy
      </li>
      <h1 className="text-xl font-bold">SECTION 7 - OPTIONAL TOOLS</h1>
      <li>
      ...
      <h1 className="text-xl font-bold">SECTION 8 - THIRD-PARTY LINKS</h1>
      <li>
      ...
      <li>
        ...
        these Terms of Service. You agree that your comments will not violate
      ...
      <li>
        ...
        non-infringement. particular purpose, durability, title, and
        non-infringement. In no case shall Richboyzph, our directors, officers,
      ...
      <h1 className="text-xl font-bold">SECTION 14 - INDEMNIFICATION</h1>
      <li>
        You agree to indemnify, defend and hold harmless Richboyzph and our
      ...
      <h1 className="text-xl font-bold">SECTION 15 - SEVERABILITY</h1>
      <li>
      ...
      <h1 className="text-xl font-bold">SECTION 16 - TERMINATION</h1>
      <li>
      ...
      <h1 className="text-xl font-bold">SECTION 17 - ENTIRE AGREEMENT</h1>
      <li>
      ...
      <h1 className="text-xl font-bold">SECTION 18 - GOVERNING LAW</h1>
      <li>
      ...
      <h1 className="text-xl font-bold">SECTION 20 - CONTACT INFORMATION</h1>
      <li>
        Questions about the Terms of Service should be sent to us at
        contact@noirclothingph@gmail.com noir-clothing.com
      </li>
    </div>
  );
};
